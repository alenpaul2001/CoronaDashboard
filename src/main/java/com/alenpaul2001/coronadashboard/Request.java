...
class Scaffold{
    ...
    public final String totalDeaths;
    
    public Scaffold(@JsonProperty("Country") String countryName,
                    @JsonProperty("CountryCode") String countryCode,
                    @JsonProperty("TotalRecovered") String totalConfirmed,
                    @JsonProperty("TotalConfirmed") String totalRecovered,
                    @JsonProperty("TotalDeaths") String totalDeaths
